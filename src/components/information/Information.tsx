...
const Information: React.FC=()=>{
    return(
        ...
        <div
          className="flex flex-col bg-[#00487B] w-[874px] py-[16px] px-[32px] rounded-[20px] items-center"
        >
          <h2 className="text-white text-md font-semibold">
            Cari Tahu Lebih Lanjut
          </h2>
          <div className="flex flex-row gap-[37px] mt-[18px]">
            <button type="button" className="flex flex-row items-center gap-[7px]">
        ...
        <div
          className="flex flex-col bg-[#00487B] w-[437px] py-[16px] px-[32px] rounded-[20px] items-center"
        >
