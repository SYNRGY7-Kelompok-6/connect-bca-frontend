      ...
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-[18px]">
          <div className="flex md:flex-row flex-col items-center font-semibold text-base text-primary-dark-blue content-center w-full lg:gap-16 gap-3">
            <label
              htmlFor="rekening"
              className="lg:w-[305px] md:w-[480px] w-full"
            >
              Rekening
            </label>
            <div className="w-full">
              <div
                className="w-full px-4 py-2 border rounded-lg border-primary-dark-blue"
        ...
        <div className="flex flex-col gap-[18px] w-full">
          <div className="flex flex-col gap-[18px] items-end">
            ...
            >
              Maksimum rentang Tanggal Awal dan Akhir mutasi adalah 31 hari dan
              harus masuk dalam periode 6 bulan transaksi terakhir.
            </span>
            <button
              onClick={handleSearch}
              className="w-[179px] justify-center flex gap-4 bg-primary-blue hover:bg-primary-dark-blue px-[36.5px] py-[10px] rounded-xl text-white font-semibold"
            >
              Cari
            </button>
          </div>
